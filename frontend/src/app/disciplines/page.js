...
export default function Page() {
  ...
  return (
    <div className="container m-auto">
      ...
      <Button onClick={() => { setNewDisciplineModalData({ update: () => { handleGetDisciplines() } }) }} className="mb-4">
          ...
          >
            ...
            <div className="flex justify-center items-center gap-2">
              <Button size="sm" onClick={(e) => {
                e.stopPropagation()
                setNewDisciplineModalData({ discipline: discipline, update: () => { handleGetDisciplines() }, editMode: true })
              }}>
                <FaEdit />
              </Button>
              <Button size="sm" onClick={(e) => {
