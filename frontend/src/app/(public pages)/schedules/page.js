          ...
          <tbody>
            {currentItems.map((schedule) => (
              <tr key={schedule.schedule_code} className="border-b">
                ...
                <td className="border border-gray-400 px-2 py-1 ">
                  <Badge type={badgeTypes?.[schedule.status.toLowerCase()]}>
                    {schedule.status}
                  </Badge>
                </td>
                <td className="border border-gray-400 px-2 py-1 ">
                ...
                <td className="border border-gray-400 px-2 py-1 ">
                  <div className="flex justify-between items-center">
                    ...
                    <a className="text-2xl text-blue-600" href={`https://www.google.com/maps/search/?api=1&query=${schedule.venue}`} target="_blank" rel="noopener noreferrer">
                      <FaMapMarkerAlt />
                    </a>
                  </div>
                </td>
