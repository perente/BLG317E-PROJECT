...
import { getTeams} from "@/service/teams_service";
      ...
      <div>
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="flex items-center">
            <label htmlFor="" className="mr-2 w-20">Team Name:</label>
            <input
              type="text"
              name="team_name"
          ...
          <div className="flex items-center">
                        <label htmlFor="country" className="mr-2 w-20">Country:</label>
          ...
          <div className="flex items-center">
            <label htmlFor="discipline" className="mr-2 w-20">Discipline:</label>
            <select className="border border-gray-400 rounded-md p-1 h-[34px] w-full"
              value={discipline}
              onChange={(e) => {
          ...
          <div>
            <label htmlFor="flex items-center" className="mr-2 w-20">Gender:</label>
            <select
              className="border border-gray-400 rounded-md p-1 h-[34px]"
              value={teamGender}
              onChange={(e) => {
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="opacity-10 flex items-center justify-center flex-col">
          <TiArrowSortedDown
            className={
              "w-5 h-5 mt-[6px] " +
              (orderBy === "country_name" && order === "asc"
                ? "opacity-100"
                : "opacity-30")
            }
            style={{ rotate: "180deg" }}
          ...
          <TiArrowSortedDown
            className={
              "w-5 h-5 mt-[-10px] " +
              (orderBy === "country_name" && order === "desc"
                ? "opacity-100"
                : "opacity-30")
            }
            style={{ rotate: "0deg" }}
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="opacity-10 flex items-center justify-center flex-col">
          <TiArrowSortedDown
            className={
              "w-5 h-5 mt-[6px] " +
              (orderBy === "discipline_name" && order === "asc"
                ? "opacity-100"
                : "opacity-30")
            }
            style={{ rotate: "180deg" }}
          ...
          <TiArrowSortedDown
            className={
              "w-5 h-5 mt-[-10px] " +
              (orderBy === "discipline_name" && order === "desc"
                ? "opacity-100"
                : "opacity-30")
            }
            style={{ rotate: "0deg" }}
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="opacity-10 flex items-center justify-center flex-col">
          ...
          <TiArrowSortedDown
            className={
              "w-5 h-5 mt-[-10px] " +
              (orderBy === "team_gender" && order === "desc"
                ? "opacity-100"
                : "opacity-30")
            }
            style={{ rotate: "0deg" }}
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="opacity-10 flex items-center justify-center flex-col">
          <TiArrowSortedDown
            className={
              "w-5 h-5 mt-[6px] " +
              (orderBy === "num_athletes" && order === "asc"
                ? "opacity-100"
                : "opacity-30")
            }
            style={{ rotate: "180deg" }}
          ...
          <TiArrowSortedDown
            className={
              "w-5 h-5 mt-[-10px] " +
              (orderBy === "num_athletes" && order === "desc"
                ? "opacity-100"
                : "opacity-30")
            }
            style={{ rotate: "0deg" }}
